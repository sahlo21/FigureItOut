...
public class PreguntaControllerA  implements Initializable  {
...
//                });
    ...
    private void resolucion(double apuesta, int numAcertadas) {
        ...
        respuestaA.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if (click.equals(answer)) {
                    modelFactoryController.setAcertadas(modelFactoryController.getAcertadas()+1);

                    if (numAcertadas==modelFactoryController.getAcertadas()) {
                        modelFactoryController.getJugadorLogueado().setSaldo(jugadorLogueado.getSaldo()+(apuesta*numAcertadas));
                        if (modelFactoryController.getAcertadas()>Integer.parseInt(modelFactoryController.getJugadorLogueado().getPuntaje())) {
                            modelFactoryController.getJugadorLogueado().setPuntaje(String.valueOf(modelFactoryController.getAcertadas()));

                        }
                        aplicacion.showResultadoIA(false,apuesta, numAcertadas);
                        modelFactoryController.setAcertadas(0);

                    }else{
                        aplicacion.showResultadoA(true,apuesta, numAcertadas);
                    }                }else{

                    aplicacion.showResultadoI(false,apuesta, numAcertadas);
    ...
    public void initAttributtes(Jugador jugadorLogueado, Pregunta preguntaAux, double apuesta, int numAcertadas) {
        ...
        resolucion(apuesta, numAcertadas);
        //                aaaa();
